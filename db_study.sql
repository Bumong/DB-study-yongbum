...
-- 테이블 데이터 db_study.student_mst:~8 rows (대략적) 내보내기
...
-- 테이블 데이터 db_study.study_notice_img:~8 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `study_writer_mst` (
  `id` int NOT NULL AUTO_INCREMENT,
  `wrter_name` varchar(50) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- 테이블 데이터 db_study.study_writer_mst:~2 rows (대략적) 내보내기
DELETE FROM `study_writer_mst`;
INSERT INTO `study_writer_mst` (`id`, `wrter_name`) VALUES
	(1, '김준일'),
	(2, '김준이');
...
INSERT INTO `user_dtl` (`id`, `phone`, `address`, `create_date`, `update_date`) VALUES
	(1, NULL, NULL, '2022-12-09 10:43:56', '2022-12-09 10:43:56'),
	(2, NULL, NULL, '2022-12-09 10:43:56', '2022-12-09 10:43:56'),
	(3, NULL, NULL, '2022-12-09 10:43:56', '2022-12-09 10:43:56'),
	(4, NULL, NULL, '2022-12-09 10:43:56', '2022-12-09 10:43:56');
...
INSERT INTO `user_mst` (`id`, `username`, `password`, `name`, `email`, `create_date`, `update_date`) VALUES
	(1, 'aaa', '1234', '김준일', 'bbb@gmail.com', '2022-12-09 10:43:56', '2022-12-09 10:43:56'),
	(2, 'bbb', '1234', '김준일', 'bbb@gmail.com', '2022-12-09 10:43:56', '2022-12-09 10:43:56'),
	(3, 'ccc', '1234', '김준일', 'bbb@gmail.com', '2022-12-09 10:43:56', '2022-12-09 10:43:56'),
	(4, 'ddd', '1234', '김준일', 'bbb@gmail.com', '2022-12-09 10:43:56', '2022-12-09 10:43:56');
