...
-- 테이블 데이터 subquery_study.user_dtl:~8 rows (대략적) 내보내기
...
-- 테이블 데이터 subquery_study.user_mst:~8 rows (대략적) 내보내기
...
-- transaction_study 데이터베이스 구조 내보내기
DROP DATABASE IF EXISTS `transaction_study`;
...
-- 테이블 transaction_study.delivery_mst 구조 내보내기
DROP TABLE IF EXISTS `delivery_mst`;
CREATE TABLE IF NOT EXISTS `delivery_mst` (
...
-- 테이블 데이터 transaction_study.delivery_mst:~4 rows (대략적) 내보내기
DELETE FROM `delivery_mst`;
INSERT INTO `delivery_mst` (`주문번호`, `배송지`) VALUES
	('202212160001', '부산 동래구 교대역점'),
	('202212160002', '부산 동래구 교대역점'),
	('202212160003', '부산 동래구 교대역점'),
	('202212160004', '부산 동래구 교대역점');

-- 테이블 transaction_study.emp_mst 구조 내보내기
...
-- 테이블 데이터 transaction_study.emp_mst:~8 rows (대략적) 내보내기
DELETE FROM `emp_mst`;
